...
model_name2="gpt-j-6B"
#strategy=(ada_icl_default random ada_icl votek)
strategy=(ada_icl_base hardest ada_icl_plus_default)
...
do
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=$((m)) python main_adaptive_phases.py  --phases 1  --few_shot 5 --task_name ${dataset[t]} --selective_annotation_method ${strategy[m]} --model_cache_dir "models" --data_cache_dir "datasets" --output_dir "outputs" --annotation_size 100 --model_name $model_name2 --seed $s --init "cluster"  --sample_k >> $aggregated_result_file &
